...
pub mod communicate_server {
    ...
    pub trait Communicate: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn transmit_command(
            &self,
            request: tonic::Request<super::CommandTrRequest>,
        ) -> std::result::Result<
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/pack.communicate/transmit_command" => {
                    #[allow(non_camel_case_types)]
                    struct transmit_commandSvc<T: Communicate>(pub Arc<T>);
                    impl<
                        T: Communicate,
                    > tonic::server::UnaryService<super::CommandTrRequest>
                    for transmit_commandSvc<T> {
                        type Response = super::CommandTrResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Communicate>::transmit_command(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = transmit_commandSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
