...
impl Packer {
    ...
    pub async fn file<'a>(&self, path: &str, content: &std::borrow::Cow<'a, [u8]>, addr: &str) {
        ...
        let args = crate::communicate::packager::ArchiveArgs {
            file_type: crate::communicate::packager::FileType::Unknown,
            solution: String::new(),
            project: String::new(),
...
mod tests {
    ...
    fn pack_tool() {
        ...
        let content = Packer::pack_compiler(env.compiler_path.to_str().unwrap(), "msvc");
    ...
    #[test]
    fn pack_includes() {
        let content = Packer::pack_dir(r"C:\Program Files (x86)\Windows Kits\10\Include\10.0.26100.0\cppwinrt", "");
